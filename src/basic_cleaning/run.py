...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "The name of the input artifact downloaded from Weights & Biases",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "The name of the output artifact downloaded from Weights & Biases",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "The minimum price threshold to keep in the dataset",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "The maxiumum price threshold to keep in the dataset",
        required = True
    )
